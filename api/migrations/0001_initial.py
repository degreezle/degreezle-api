# Generated by Django 3.2.14 on 2022-07-13 07:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_created', models.DateTimeField(auto_now_add=True)),
                ('object_modified', models.DateTimeField(auto_now=True)),
                ('puzzle', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='solutions', related_query_name='solution', to='api.puzzle')),
            ],
        ),
    ]
